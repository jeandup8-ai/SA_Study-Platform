...
export function PrivacyPage() {
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated="13 September 2026">
      ...
      <h2>Payments</h2>
      <p>
        Billing is handled by PayFast, a South African payment provider. When you subscribe, you
        are taken to PayFast's own secure checkout page to enter your card details directly with
